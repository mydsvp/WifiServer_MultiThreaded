 ...
 *
 */
public class SimpleWireTransport  extends GPRSTransport 
{
	@Override
	protected void sendSMS(SSPModel model, String emailPacket) throws Exception
	{
	    CommServer.log4j.debug("Sending SMS message. ");
		...
		CommServer.log4j.debug("Sending SMS message " + emailPacket);
		...
		CommServer.log4j.debug("Exiting sending of SMS Message");
